...
import com.maplequad.fo.ods.tradecore.lcm.services.TradeConverterService;
import com.maplequad.fo.ods.tradecore.lcm.services.TradeGeneratorService;
import com.maplequad.fo.ods.tradecore.lcm.services.TradePersistenceService;
import com.maplequad.fo.ods.tradecore.lcm.services.TradeRetrievalService;
 ...
 * @since :   23/07/2017
 */
public class TradeCoreApp {

    private static final Logger LOGGER = LoggerFactory.getLogger(TradeCoreApp.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        perService = new TradePersistenceService(batchSize);
        retService = new TradeRetrievalService(assetClass);
