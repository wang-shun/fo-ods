...
/**
 * TradeCoreBalcmAppClient -
 * This can be used to test the Bulk Amend Functionality
 *
 * @author Madhav Mindhe
 * @since :   08/09/2017
 */
public class TradeCoreBalcmAppClient {
    ...
    public static void main(String[] args) {
        LOGGER.info("Starting the TradeCoreBalcmAppClient..");
        ...
        .setDescription("Trade Compression of IRS Trades # "+runNumber)
        .setType(
            BulkAmendOuterClass.BulkAmendDetails.newBuilder().
        ...
        BulkAmendResponse init = tradeCoreBulkAmendService.initiateBulkAmend(amend);
