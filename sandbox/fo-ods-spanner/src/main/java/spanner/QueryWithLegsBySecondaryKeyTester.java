 ...
 */
public class QueryWithLegsBySecondaryKeyTester extends QueryTester.BaseQueryTesterFunc {
    ...
    protected void init() {
        ...
        select = "select " + tradeColumnList + ", " + legsColumnList +
            " from trades4@{FORCE_INDEX=idxAccount} t, trades4_legs l " +
