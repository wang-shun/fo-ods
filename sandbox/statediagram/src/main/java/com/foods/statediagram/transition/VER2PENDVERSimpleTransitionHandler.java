...
public class VER2PENDVERSimpleTransitionHandler extends AbstractTransitionHandler {
	static Logger logger = LoggerFactory.getLogger(VER2PENDVERSimpleTransitionHandler.class);
