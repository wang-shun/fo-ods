...
public class NEW2DONESimpleTransitionHandler extends AbstractTransitionHandler {
	static Logger logger = LoggerFactory.getLogger(NEW2DONESimpleTransitionHandler.class);
