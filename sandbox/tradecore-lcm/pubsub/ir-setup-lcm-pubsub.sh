...
export LCM_TOPIC_NAME=sit-ir-lcm-feed
export DLT_ERR_TOPIC_NAME=sit-ir-dlt-err
export DLT_SUB_NAME=sit-ir-lcm-feed-dlt-sub
export VS_SUB_NAME=sit-ir-lcm-feed-vs-sub
export DIST_SUB_NAME=sit-ir-lcm-feed-dist-sub
export DLT_ERR_SUB_NAME=sit-ir-dlt-err-sub
