...
export LCM_TOPIC_NAME=sit-fx-lcm-feed
export DLT_ERR_TOPIC_NAME=sit-fx-dlt-err
export DLT_SUB_NAME=sit-fx-lcm-feed-dlt-sub
export VS_SUB_NAME=sit-fx-lcm-feed-vs-sub
export DIST_SUB_NAME=sit-fx-lcm-feed-dist-sub
export DLT_ERR_SUB_NAME=sit-fx-dlt-err-sub
